...
def train(train_set, dev_set, test_set, params, log):
    """
    ...
    if params.training_setting["test_only"]:
        ...
        with open("../../KnowMan/save/labels_l0_imdb_tfidf.csv", "w")as out:
...
def main():
    ...
    imdb_params.update_parameters("./imdb_tfidf.yaml")
    ...
    train_dataset, dev_dataset, test_dataset = get_dataset(imdb_params.dataset["dataset_path"])

    cv = train(train_dataset, dev_dataset, test_dataset, imdb_params, log)
